...
#
for i in {0..1}; do ffmpeg -r 10 -i ${p}/cars-sample-1-00000${i}-%d.png ${p}/cars-sample-${i}.mp4; done
for i in {0..1}; do ffmpeg -r 10 -i ${p}/cars_det-sample-1-00000${i}-%d.png ${p}/cars_det-sample-${i}.mp4; done
for i in {0..1}; do fmpeg -i ${p}/cars-step-1-00000${i}-%d.png ${p}/cars-${i}.mp4; done
for i in {0..1}; do fmpeg -i ${p}/cars_det-step-1-00000${i}-%d.png ${p}/cars_det-${i}.mp4; done
